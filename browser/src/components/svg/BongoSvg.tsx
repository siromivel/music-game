  ...
  return (
    <div className="token-svg">
      ...
      >
        ...
        <path
          style={tertiary}
          d="M462.08,167.63H322.758c-14.533,0-26.423,11.89-26.423,26.423v14.581
        ...
        <path
          style={primary}
          d="M342.356,208.635v-14.581c0-14.533,11.89-26.423,26.423-26.423h-46.02
        ...
        <path
          style={tertiary}
          d="M189.575,166.041H50.253c-14.533,0-26.423,11.89-26.423,26.423v14.581
        ...
        <g>
          <path
            style={primary}
            d="M69.85,207.045v-14.581c0-14.533,11.89-26.423,26.423-26.423h-46.02
                        c-14.533,0-26.423,11.89-26.423,26.423v14.581c0,14.533,11.89,26.423,26.423,26.423h46.02
        ...
        <path
          style={secondary}
          d="M454.281,312.494c-4.333,0-7.844-3.512-7.844-7.844v-60.344c0-4.332,3.511-7.844,7.844-7.844
        ...
        <path
          style={secondary}
          d="M182.693,312.494c-4.332,0-7.844-3.512-7.844-7.844v-60.344c0-4.332,3.512-7.844,7.844-7.844
                    c4.332,0,7.844,3.512,7.844,7.844v60.344C190.537,308.982,187.025,312.494,182.693,312.494z"
        />
        <path
          d="M499.883,336.358c15.029-37.5,17.001-84.542,0.665-118.052c2.211-1.745,3.642-4.439,3.642-7.457
